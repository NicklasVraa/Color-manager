# NovaOS Icons
This repository contains multiple collections of vector/svg icon packs. For now, mostly monochromatic variants of the [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) icon pack. Each pack contains around 5000 icons. Feel free to [request](#requests) a variant of any publically available icon pack.
...
## Packs
### Monochromatic Packs
| **Papirus Variants**       | Examples | Status |
| -------------------------- | -------- | -------|
...
| **Zafiro Variants**       | Examples | Status |
| ------------------------- | -------- | -------|
...
| **Zafiro Variants**       | Examples | Status |
| ------------------------- | -------- | -------|
| Nord (8 tones) | <img src="previews/_test_pack/_2/colors.png" width="50"/>  <img src="previews/_test_pack/_2/firefox.png" width="50"/> <img src="previews/_test_pack/_2/vscode.png" width="50"/> <img src="previews/_test_pack/_2/account.png" width="50"/>  <img src="previews/_test_pack/_2/video.png" width="50"/> <img src="previews/_test_pack/_2/git.png" width="50"/> | Finished |
